...
#include <data_carriage_interface/msg/float32_fix_array.h>
...
rcl_timer_t timer_;
int sync_counter = 0;
rcl_publisher_t f32array_pub;
float f32array_data[29];
std_msgs__msg__Float32MultiArray f32array_msg = {
    .data = { .data = f32array_data, .capacity = 29, .size = 29 }
};
...
//    f32array_msg.data.capacity = 29;  // Adjust capacity as needed
